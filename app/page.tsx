...
export default function SmileCraft() {
  ...
  const submitForm = () => {
    ...
    alert("Thank you, " + name + "! Dr. Mehta's team will contact you within 2 hours to confirm your appointment. You can also reach us on WhatsApp for faster response.");
  };
    ...
    <>
      ...
      <section id="doctor">
        <div className="doctor-inner">
          ...
          <div className="doctor-content reveal">
            ...
            <a href="#contact" className="btn-primary" style={{ marginTop: '2rem', display: 'inline-block' }} onClick={(e) => handleSmoothScroll(e, 'contact')}>Meet Dr. Mehta →</a>
          </div>
        </div>
      </section>
          ...
          <div className="contact-info reveal">
            ...
            <div className="contact-detail">
              ...
              <div>
                ...
                <div className="contact-val"><a href="tel:+919876543210" style={{ color: 'var(--cream)', textDecoration: 'none' }}>+91 98765 43210</a></div>
              </div>
            </div>
            <div className="contact-detail">
              <div className="contact-icon">🕐</div>
            ...
            <div className="map-embed">
              <iframe
                src="https://maps.google.com/maps?q=Koregaon+Park+Pune&t=&z=15&ie=UTF8&iwloc=&output=embed"
                width="100%" height="220" style={{ border: 0, filter: 'grayscale(100%) invert(90%) contrast(80%)' }}
      ...
      <footer>
        <div className="footer-inner">
          ...
          <div className="footer-text">© 2025 SmileCraft Dental Studio · Koregaon Park, Pune</div>
        </div>
      </footer>
